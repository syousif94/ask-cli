rewrite the following ripgrep homebrew formula for another rust executable, ask-cli. The ask-cli executable is called ask. the repo is github.com/syousif94/ask-cli
